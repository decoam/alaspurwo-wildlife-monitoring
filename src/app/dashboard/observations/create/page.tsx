...
export default async function CreateObservationPage() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(16,64,38,0.5),_transparent_35%),linear-gradient(135deg,_#07110c_0%,_#0c1914_45%,_#13261d_100%)] px-4 py-6 text-text-light sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl rounded-[28px] border border-brand-primary/60 bg-surface-bg/80 p-4 shadow-[0_20px_60px_rgba(2,8,23,0.2)] md:p-6">
        <div className="border-b border-brand-primary/60 pb-6">
          <p className="text-sm font-semibold uppercase tracking-[0.25em] text-brand-text">Tambah Pengamatan</p>
          <h1 className="mt-2 text-2xl font-semibold text-text-heading">Form Pengamatan Satwa</h1>
          <p className="mt-2 text-sm text-text-muted">Isi data pengamatan sesuai dengan kondisi lapangan dan unggah foto bukti.</p>
        </div>
