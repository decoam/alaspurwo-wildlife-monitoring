...
export function DashboardShell({ user, children }: DashboardShellProps) {
  ...
  return (
    <div className="h-screen overflow-hidden bg-[#07110c] text-slate-100">
       ...
       * h-full overflow-y-auto — only this area scrolls; sidebar stays fixed.
       * Each child page owns its own inner padding via its CSS utility classes.
       */}
      <div className="md:pl-72 pt-14 md:pt-0 h-full overflow-y-auto">
        {children}
      </div>
