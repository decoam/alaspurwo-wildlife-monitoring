...
export function ManagerHeader({ 
  ...
  return (
    <header className="flex flex-row items-center justify-between gap-4 rounded-[24px] md:rounded-[28px] border border-emerald-900/60 bg-[#0c1914]/85 p-4 md:px-5 md:py-4 shadow-[0_20px_60px_rgba(2,8,23,0.2)]">
      ...
      <div className="min-w-0 flex-1 sm:flex-initial">
        ...
        <h1 className="mt-0.5 text-base md:text-2xl font-semibold text-white truncate max-w-[180px] xs:max-w-[240px] sm:max-w-md">
          {title}
        </h1>
      </div>
      ...
      <div className="flex items-center gap-2 sm:gap-3 shrink-0">
        ...
        <div className="flex items-center gap-2 md:gap-3 rounded-2xl border border-emerald-900/60 bg-[#10241a] p-1 sm:py-1.5 sm:pl-1.5 sm:pr-3 md:py-2">
          ...
          <div className="flex h-8 w-8 md:h-10 md:w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-lime-600 text-xs md:text-sm font-semibold text-white shadow-md">
            {user.avatarInitials}
          </div>
